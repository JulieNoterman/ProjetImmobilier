...
public class ClientControllerImplTest extends TestMvc {
	...
	public void saveValidClientAssociatedWithBien_shouldReturnClientWithIdNotNull() throws UnsupportedEncodingException, JsonProcessingException, Exception {
		//preparer les inputs
		ClientSaveDto c = new ClientSaveDto();
		c.setId(45687L);
		c.setEmail("email2@adaming.fr");
	...
	public void saveNotValidClient_shouldReturndNull() throws UnsupportedEncodingException, JsonProcessingException, Exception {
		//preparer les inputs
	...
	@Test
	@Sql(statements = "delete from client where id = 1455454", executionPhase = ExecutionPhase.AFTER_TEST_METHOD)
	public void saveClientWithNotValidEmail_shouldReturndNull() throws UnsupportedEncodingException, JsonProcessingException, Exception {
		//preparer les inputs
		ClientSaveDto c = new ClientSaveDto();
		c.setId(1455454L);
		c.setEmail("abcde");
...
//	
	...
	public void deleteExistingClient_shouldReturnTrue() throws UnsupportedEncodingException, JsonProcessingException, Exception {
		//preparer les inputs
		ClientSaveDto c = new ClientSaveDto();
		c.setId(232323L);
	...
	@Test
	public void updateNotExistingClient_shouldReturnNull() throws UnsupportedEncodingException, JsonProcessingException, Exception {
		//preparer les inputs
		Client c = new Client();
		c.setId(121212L);
